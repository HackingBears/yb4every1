...
export default class PlayerObject extends ExtendedObject3D {
    ...
    activatePhysics(){
        this.position.set(this.ps.x * this.positionExtensionFactor, 0.2, this.ps.y * this.positionExtensionFactor);
